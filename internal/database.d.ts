...
export declare function dbGet(contract: usize, table: usize, tableLen: u32, key: usize, keyLen: u32, buffer: usize, len: u32): void;

@external("damoclis", "dbStore")
export declare function dbStore(contract: usize, table: usize, tableLen: u32, key: usize, keyLen: u32, buffer: usize, len: u32): void;
