(module
 ...
 (func $system/system#constructor (; 31 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 16
 ...
 (func $system/system#nowTest (; 41 ;) (type $FUNCSIG$ji) (param $0 i32) (result i64)
  call $../../src/system/Now
 )
 ...
 (func $system/system#genesisTimeTest (; 44 ;) (type $FUNCSIG$ji) (param $0 i32) (result i64)
 ...
 (func $system/system#assertExitTestTrue (; 46 ;) (type $FUNCSIG$vi) (param $0 i32)
  i32.const 1
  i32.const 1
  i32.eq
  i32.const 1
 ...
 (func $system/system#assertExitTestFalse (; 47 ;) (type $FUNCSIG$vi) (param $0 i32)
  i32.const 1
  i32.const 2
  i32.eq
  i32.const 2
 ...
 (func $system/apply (; 48 ;) (type $FUNCSIG$v)
  ...
  (local $2 i64)
  i32.const 0
  call $system/system#constructor
  local.set $0
  local.get $0
  ...
  if
   local.get $0
   call $system/system#genesisTimeTest
   local.set $2
   local.get $0
   local.get $2
   call $../../src/contract/Contract#ReturnU64
  ...
  if
   local.get $0
   call $system/system#assertExitTestTrue
  end
  local.get $0
  i32.const 2848
  call $../../src/contract/Contract#isAction
  if
   local.get $0
   call $system/system#assertExitTestFalse
  end
  local.get $0
  call $~lib/rt/stub/__release
  local.get $1
