(module
 ...
 (import "damoclis" "getTxHash" (func $internal/transaction.d/getTxHash (param i32)))
 (import "damoclis" "returnData" (func $internal/action.d/returnData (param i32 i32)))
 (import "damoclis" "getSignature" (func $internal/transaction.d/getSignature (param i32)))
 (memory $0 1)
 ...
 (data (i32.const 2696) "\1a\00\00\00\01\00\00\00\01\00\00\00\1a\00\00\00g\00e\00t\00T\00x\00H\00a\00s\00h\00T\00e\00s\00t\00")
 (data (i32.const 2744) " \00\00\00\01\00\00\00\01\00\00\00 \00\00\00g\00e\00t\00S\00i\00g\00n\00a\00t\00u\00r\00e\00T\00e\00s\00t\00")
 (table $0 1 funcref)
 ...
 (global $~lib/heap/__heap_base i32 (i32.const 2792))
 (export "memory" (memory $0))
 (export "apply" (func $test/transaction/transaction/apply))
 (start $start)
 ...
 (func $test/transaction/transaction/TransactionTest#constructor (; 30 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 16
 ...
 (func $src/transaction/Transaction.getTxHash (; 39 ;) (type $FUNCSIG$i) (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  i32.const 0
  ...
  call $~lib/typedarray/Uint8Array#get:buffer
  local.tee $1
  call $internal/transaction.d/getTxHash
  local.get $0
  local.set $2
  local.get $1
  call $~lib/rt/stub/__release
 ...
 (func $test/transaction/transaction/TransactionTest#getTxHashTest (; 40 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  call $src/transaction/Transaction.getTxHash
 )
 (func $~lib/bytes/Bytes#get:bytes (; 41 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
  call $~lib/rt/stub/__retain
 )
 (func $src/contract/Contract#ReturnBytes (; 42 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $1
  call $~lib/rt/stub/__retain
  drop
 ...
 (func $src/transaction/Transaction.getSignature (; 43 ;) (type $FUNCSIG$i) (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  i32.const 0
  ...
  call $~lib/typedarray/Uint8Array#get:buffer
  local.tee $1
  call $internal/transaction.d/getSignature
  local.get $0
  local.set $2
  local.get $1
  call $~lib/rt/stub/__release
 ...
 (func $test/transaction/transaction/TransactionTest#getSignatureTest (; 44 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  call $src/transaction/Transaction.getSignature
 )
 (func $test/transaction/transaction/apply (; 45 ;) (type $FUNCSIG$v)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 0
  call $test/transaction/transaction/TransactionTest#constructor
  local.set $0
  local.get $0
  ...
  if
   local.get $0
   call $test/transaction/transaction/TransactionTest#getTxHashTest
   local.set $2
   local.get $0
   local.get $2
  ...
  if
   local.get $0
   call $test/transaction/transaction/TransactionTest#getSignatureTest
   local.set $3
   local.get $0
   local.get $3
   call $~lib/bytes/Bytes#get:bytes
