(module
 ...
 (data (i32.const 2744) "\1e\00\00\00\01\00\00\00\01\00\00\00\1e\00\00\00g\00e\00t\00S\00i\00n\00a\00t\00u\00r\00e\00T\00e\00s\00t\00")
 (table $0 1 funcref)
 ...
 (export "apply" (func $transaction/apply))
 (start $start)
 ...
 (func $transaction/TransactionTest#constructor (; 30 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 16
 ...
 (func $transaction/TransactionTest#getTxHashTest (; 40 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
 ...
 (func $transaction/TransactionTest#getSinatureTest (; 44 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  call $../../src/transaction/Transaction.getSignature
 )
 (func $transaction/apply (; 45 ;) (type $FUNCSIG$v)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 0
  call $transaction/TransactionTest#constructor
  local.set $0
  local.get $0
  ...
  if
   local.get $0
   call $transaction/TransactionTest#getTxHashTest
   local.set $2
   local.get $0
   local.get $2
  ...
  if
   local.get $0
   call $transaction/TransactionTest#getSinatureTest
   local.set $3
   local.get $0
   local.get $3
   call $~lib/bytes/Bytes#get:bytes
