(module
 ...
 (func $fibonacci/Fibonacci#constructor (; 28 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 16
 ...
 (func $fibonacci/Fibonacci#compute (; 38 ;) (type $FUNCSIG$jij) (param $0 i32) (param $1 i64) (result i64)
  (local $2 i64)
  (local $3 i64)
  (local $4 i64)
  (local $5 i64)
 ...
 (func $../../../src/contract/Contract#ReturnU64 (; 39 ;) (type $FUNCSIG$vij) (param $0 i32) (param $1 i64)
  local.get $1
 ...
 (func $fibonacci/apply (; 41 ;) (type $FUNCSIG$v)
  ...
  (local $3 i64)
  i32.const 0
  call $fibonacci/Fibonacci#constructor
  local.set $0
  local.get $0
  ...
  if
   ...
   local.get $0
   local.get $2
   call $fibonacci/Fibonacci#compute
   local.set $3
   local.get $0
   local.get $3
